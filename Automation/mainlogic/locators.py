...
class Locators:
    cart_locator = (By.CLASS_NAME, 'ico-cart')
    term_of_service_locator = (By.ID, 'termsofservice')
    checkout_locator = (By.ID, 'checkout')
    continue_locator = (By.XPATH, '//*[@id="billing-buttons-container"]/input')
...
#_________________________
    path_of_items = (By.XPATH, '/html/body/div[4]/div[1]/div[4]/div[2]/div[2]/div[2]/div[3]')
